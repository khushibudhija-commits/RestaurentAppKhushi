...
import appetizers from "../menuitems/appetizersdata";
...
const Slider = SliderModule.default;
  ...
  return (
    <section
      className={`min-h-screen py-20 px-6 transition-all cursor-pointer duration-500 ${
        isDark
                ...
                <div className="p-6 text-center">
                 ...
                 hover:bg-green-600 transition text-lg font-bold"
                  ...
                  <button
                    ...
                    className={`mt-5 px-8 py-3 rounded-full font-semibold
