...
import { Users, UtensilsCrossed, Award } from "lucide-react";
...
const featuredItems = [
  ...
  },
  {
    id: 2,
    title: "Creamy Pasta",
    description: "Rich creamy sauce with herbs.",
    image: "/appetizers/pasta.jpeg",
    route: "/home/appetizers",
    delay: "0.2s",
  },
  {
    id: 3,
    ...
    image: "/appetizers/burger.jpeg",
    route: "/home/appetizers",
    delay: "0.5s",
  },
  {
    id: 4,
    title: "Kesar GulabJamun",
    description: "Hot & Delicious.",
    image: "/desserts/gulabjamun.jpg",
    route: "/home/desserts",
    delay: "0.8s",
  },
  {
    id: 5,
    title: "Italian Pizza",
    description: "Fresh mozzarella & basil toppings.",
...
const stats = [
  {
    ...
    description:
      "Thousands of satisfied customers who love our food and hospitality.",
  },
  {
    ...
    description:
      "A wide variety of cuisines prepared with premium ingredients.",
  },
  {
    ...
    title: "Expert Chefs",
    description:
      "Professional chefs creating unforgettable dining experiences.",
  },
  {
    icon: <Award size={40} />,
    number: "25+",
    ...
    description:
      "Serving delicious food with excellence and passion since day one.",
  },
];
...
const Home = () => {
  ...
  return (
    <div>
      <section
        className="relative bg-no-repeat bg-cover overflow-hidden  bg-center transition-all duration-700 
        min-h-screen"
        style={{
...
"
          >
            <p className={isDark ? "text-white" : "text-[#3c2415] mb-4"}>
          ...
          <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl">
            ...
            >
              <h2 className="text-3xl font-bold text-[#D6B56C]">25+</h2>
            ...
            >
              <h2 className="text-3xl font-bold text-[#D6B56C]">50+</h2>
            ...
            >
              <h2 className="text-3xl font-bold text-[#D6B56C]">20k+</h2>
            ...
            >
              <h2 className="text-3xl font-bold text-[#D6B56C]">4.9★</h2>
  ...
  "
          >
              {featuredItems.map((item) => (
                <div
                  key={item.id}
                  className={`group rounded-3xl overflow-hidden backdrop-blur-lg
      transition-all duration-700 hover:-translate-y-4 hover:scale-[1.02]
      ${
        isDark
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div>
                ...
                >
                  From carefully selected ingredients to beautifully plated
                  dishes, every meal is prepared to give you an unforgettable
                  dining experience.
                </p>
              </div>
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              >
                Our passion for delicious food and outstanding service has
