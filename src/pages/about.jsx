          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              >
                ...
                beverages, offering something to satisfy every palate.

                We believe that great food is best enjoyed in a comfortable
                environment, complemented by friendly service and genuine
                hospitality.

                Thank you for choosing us. We look forward to welcoming you and
                serving meals that bring people together, create lasting
                memories, and celebrate the joy of great food.
              </p>
              ...
              <button
                className={`mt-8 md:mt-12 border px-6 md:px-10 py-3 md:py-4 tracking-[2px] md:tracking-[3px] uppercase transition duration-500 ${
                  isDark
            ...
            <div className="relative w-full mt-12 lg:mt-0">
              ...
              <div className="hidden sm:block h-[420px] sm:h-[520px] md:h-[620px] lg:h-[720px] relative">
                ...
                <div
                  className={`absolute top-4 right-4 sm:right-8 md:right-14 lg:right-20 w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-full backdrop-blur-md border flex items-center justify-center shadow-xl animate-[spin_10s_linear_infinite] ${
                    isDark
              ...
              <div className="sm:hidden grid grid-cols-1 gap-4">
                ...
                <div className={`rounded-2xl px-4 py-3 ${isDark ? "bg-[#1a1a1a] text-gray-300" : "bg-white text-gray-700"} shadow-lg`}> 
                  <div className="flex items-baseline justify-between">
                    <div>
                      <h2 className={`text-2xl font-bold ${isDark ? "text-[#d6b56c]" : "text-[#8a4b12]"}`}>25+</h2>
                      <p className="text-sm">Years of Excellence</p>
                    </div>
                    <div className="text-right">
                      <p className={`uppercase text-xs tracking-widest ${isDark ? "text-[#d6b56c]" : "text-[#8a4b12]"}`}>Since</p>
                      <p className={`text-lg font-serif font-bold ${isDark ? "text-white" : "text-[#2f2113]"}`}>1999</p>
                    </div>
                  </div>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            authentic flavors, premium ingredients, exceptional hospitality,
            and innovative culinary excellence.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            ...
            >
              ...
              high-quality food prepared with passion and care. We are committed
              to creating memorable dining experiences through exceptional
              service, warm hospitality, and a welcoming atmosphere where
              families and friends can celebrate life's special moments.
            </p>
          ...
          >
            ...
            >
              ...
              customer satisfaction, and innovation. We aspire to build lasting
              relationships with our guests while continuously evolving to offer
              unforgettable dining experiences for every generation.
            </p>
