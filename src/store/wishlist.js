  ...
  persist(
    (set, get) => ({
      ...
      fetchWishlist: async () => {
        ...
        try {
          const response = await fetch(
            `https://restraunt-app-backend.onrender.com/api/wishlist/user/${user._id}`
          );
      ...
      addToWishlist: async (item) => {
        ...
        if (user?._id) {
          try {
            await fetch("https://restraunt-app-backend.onrender.com/api/wishlist/add", {
              method: "POST",
      ...
      removeFromWishlist: async (id) => {
        ...
        if (user?._id) {
          try {
            await fetch("https://restraunt-app-backend.onrender.com/api/wishlist/remove",
               {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
      ...
      clearWishlist: async () => {
        ...
        if (user?._id) {
          try {
            await fetch(`https://restraunt-app-backend.onrender.com/api/wishlist/user/${user._id}`, {
              method: "DELETE",
            });
          } catch (err) {
